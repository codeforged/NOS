  ...
  application: (uuid) => {
    ...
    let appContent = {
      header: {
        ...
        active: true,
        version: "1.2",
        icon: "/opt/gui/images/icon/icon_32_computer.png",
